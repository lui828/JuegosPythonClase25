...
def ahorcado():
    palabras = {
        ...
        "programacion": "El proceso de crear software.",
        "ahorcado": "Un juego de adivinanza de letras.",
        "desarrollo": "El proceso de crear software y aplicaciones.",
        "juego": "Una actividad recreativa o entretenimiento."
    }

    palabra_secreta = random.choice(list(palabras.keys()))
    pista = palabras[palabra_secreta]
    letras_adivinadas = []
    intentos = 6

    # Mostrar la pista al inicio
